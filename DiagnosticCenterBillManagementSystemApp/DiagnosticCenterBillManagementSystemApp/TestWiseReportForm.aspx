<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestWiseReportForm.aspx.cs" Inherits="DiagnosticCenterBillManagementSystemApp.TestWiseReportForm" %>
...
<div class="page-wrapper">
    ...
    <div class="container">
        <form id="form1" runat="server" class ="well form-horizontal"  method="post" >
            <fieldset>
                <!-- Form Name -->
                <legend><center><h2><b>TEST WISE REPORT</b></h2></center></legend><br>
                ...
                <div class="form-group">
                    ...
                    <div class="table-responsive" div style="overflow: scroll; height: 200px;"> 
                        <asp:GridView ID="testWiseGridView" showHeader="False" class="col-md-4 inputGroupContainer" runat="server" style="margin-left: 15%; margin-right: 15%;" Width="70%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False"  EmptyDataText="There are no data records to display.">  
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:Label Text='<%#Eval("Total Test")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
