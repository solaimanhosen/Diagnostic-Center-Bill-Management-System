<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TypeWiseReportForm.aspx.cs" Inherits="DiagnosticCenterBillManagementSystemApp.TypeWiseReportForm" %>
...
<div class="page-wrapper">
    ...
    <div class="container">
        <form id="form1" runat="server" class ="well form-horizontal"  method="post" >
            <fieldset>
                <!-- Form Name -->
                <legend><center><h2><b>TEST TYPE WISE REPORT</b></h2></center></legend><br>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            ...
                            <input runat="server"  name="fromDate" id="fromDate"  class = "form-control" type="date" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                            <input runat="server"  name="toDate" id="toDate"  class = "form-control" type="date" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <table ID="myTable"  class="table table-fixed" style="width: 80%;margin-left: 15%; ">
                        ...
                        <tr>
                            ...
                            <th class="col-xs-3">TOTAL TEST</th>
                            <th class="col-xs-3">TOTAL AMOUNT</th>    
                        </tr>
                        </thead>
                    </table>
                    <div class="table-responsive" div style="overflow: scroll; height: 200px;"> 
                        <asp:GridView ID="typeWiseGridView" showHeader="False" class="col-md-4 inputGroupContainer" runat="server" style="margin-left: 15%; margin-right: 15%;" Width="70%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False"  EmptyDataText="There are no data records to display.">  
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:Label Text='<%#Eval("Test Type Name")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:Label Text='<%#Eval("Total No Of Test")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:Label Text='<%#Eval("Total Amount")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>  
                            </Columns>
                        </asp:GridView>  
