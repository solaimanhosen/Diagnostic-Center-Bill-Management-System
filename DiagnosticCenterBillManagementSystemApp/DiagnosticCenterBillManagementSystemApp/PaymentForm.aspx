<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentForm.aspx.cs" Inherits="DiagnosticCenterBillManagementSystemApp.PaymentForm" %>
...
<div class="page-wrapper">
    ...
    <div class="container">
        <form id="form1" runat="server" class ="well form-horizontal"  method="post" >
            <fieldset>
                <!-- Form Name -->
                <legend><center><h2><b>PAYMENT</b></h2></center></legend><br>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            ...
                            <input runat="server"  name="billno" id="billno" placeholder="Bill No" class="form-control"  type="text"/>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
                            <input runat="server"  name="mobileno" id="mobileno" placeholder="mobileno" class="form-control"  type="text"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4" style="margin-left: 58%;"><br>
                        <asp:Button type="submit" class="btn btn-warning"  runat="server" ID="searchButton" Text="SEARCH" OnClick="searchButton_Click"  />
                    </div>
                </div>
            
                <legend><center><h2><b>&nbsp</b></h2></center></legend><br>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            ...
                            <input runat="server"  name="amount" id="amount" placeholder="" class="form-control"  type="text" disabled />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
                            <input runat="server"  name="entrydate" id="entrydate" placeholder="" class="form-control"  type="text" disabled />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label"></label>
                    <div class="col-md-4" style="margin-left: 58%;"><br>
                        <asp:Button type="submit" class="btn btn-warning"  runat="server" ID="payButton" Text="PAY" OnClick="payButton_Click"  />
                    </div>
                </div>
