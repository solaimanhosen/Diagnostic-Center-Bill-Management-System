<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestNameSetupForm.aspx.cs" Inherits="DiagnosticCenterBillManagementSystemApp.TestNameForm" %>
            ...
            $("#form1").validate({
                ...
                messages: {
                    testname: {
                        ...
                        minlength: "Test Name must contain at least 3 characters"
                    },
                    testfeee: {
                        required: "Fee can't be blanked",
...
<div class="page-wrapper">
    ...
    <div class="container">
        <form id="form1" runat="server" class ="well form-horizontal" onsubmit="return checkInp()" method="post" >
            <fieldset>
                <!-- Form Name -->
                <legend><center><h2><b>Test Setup</b></h2></center></legend><br>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            ...
                            <input runat="server"  name="testname" id="testname" placeholder="Test Name" class="form-control"  type="text"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
                            <input runat="server"  name="testfee" id="testfee" placeholder="Test Fee" class="form-control"  type="text"/>
                        </div>
                    </div>
                    <label class="col-md-4">BDT</label> 
                </div>
                ...
                <div class="form-group"> 
                    ...
                    <div class="col-md-4 selectContainer">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
                            <asp:DropDownList id="testTypeDropDownList"  runat="server" name="testtype"  AutoPostBack="True" class="form-control selectpicker"></asp:DropDownList>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4" style="margin-left: 58%;"><br>
                        <asp:Button type="submit" class="btn btn-warning"  runat="server" ID="saveTestButton" Text="SAVE" OnClick="saveTestButton_Click"  />
                    </div>
                </div>
                ...
                <div class="form-group">
                    <table ID="myTable"  class="table table-fixed" style="width: 80%;margin-left: 15%; ">
                        <thead >
                        <tr>
                            <th  class="col-xs-3">SL</th>
                            <th  class="col-xs-3">TEST NAME</th>
                            <th class="col-xs-3">FEE</th>
                            <th class="col-xs-3">TYPE</th>    
                        </tr>
                        </thead>
                    </table>
                    <div class="table-responsive" div style="overflow: scroll; height: 200px;"> 
                        <asp:GridView ID="testNameGridView" showHeader="False" class="col-md-4 inputGroupContainer" runat="server" style="margin-left: 15%; margin-right: 15%;" Width="70%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False"  EmptyDataText="There are no data records to display.">  
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:Label Text='<%#Eval("Test Name")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:Label Text='<%#Eval("Test Fee")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:Label Text='<%#Eval("Test Type")%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>  
                            </Columns>
                        </asp:GridView>  
